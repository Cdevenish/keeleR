...
```{r galls2-solution, exercise.setup = "galls1", exercise.reveal_solution = TRUE}
...
```{r plot2-solution, exercise.setup = "galls1", exercise.reveal_solution = TRUE}
...
```{r mean2-solution, exercise.setup = "galls1", exercise.reveal_solution = TRUE}
...
```{r boxplot2-solution, exercise.setup = "galls1", exercise.reveal_solution = TRUE}
