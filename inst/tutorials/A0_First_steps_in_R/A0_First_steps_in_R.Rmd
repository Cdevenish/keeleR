...
It might be useful to know the mean height of trees for each species. We can use the `tapply()` function for this. This function allows us to apply a function across different groups of a column.
