...
## 7 Your first script in RStudio
...
and then stop the tutorial by closing the window. Paste the code into the console and run it! Your first script should open. Before you do anything else save it on your computer. Then continue to follow the instructions in the script.
